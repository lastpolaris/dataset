...
def main():
    ...
    camera_param = [18,1280,720,23.76,13.365]
    ego_global_rotation = [0,-79,-215]
    ego_global_translation = [-4803,-4216,3578]
    ...
    print(meta)
    dataroot ='D:/BaiduNetdiskDownload/2人1车4树/'
    with open(dataroot + '/camera3.json', 'w') as file:
        file.write(json_str)    
